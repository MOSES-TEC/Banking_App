...
class Account(models.Model):
    ...
    account_number = ShortUUIDField(unique=True, length=10, max_length=25, prefix="007", alphabet="1234567890")
    account_id = ShortUUIDField(unique=True, length=10, max_length=25, prefix="NMR", alphabet="1234567890")
    pin_number = ShortUUIDField(unique=True, length=4, max_length=7, alphabet="1234567890") #1710
